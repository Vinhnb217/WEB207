            ...
            <div className="row single-slide align-items-center d-flex">
              ...
              <div className="col-lg-7">
                <div className="banner-img">
                  <img className="img-fluid" src="client/img/banner/banner-img.png" alt />
                </div>
              </div>
            </div>
            {/* single-slide */}
    ...
    <div className="container">
      <div className="row justify-content-center">
          ...
          <div className="row">
            <div className="col-lg-8 col-md-8">
              <div className="single-deal">
                ...
                <img className="img-fluid w-100" src="client/img/category/c1.jpg" alt />
            ...
            <div className="col-lg-4 col-md-4">
              <div className="single-deal">
                <div className="overlay" />
                <img className="img-fluid w-100" src="client/img/category/c2.jpg" alt />
            ...
            <div className="col-lg-4 col-md-4">
              <div className="single-deal">
                <div className="overlay" />
                <img className="img-fluid w-100" src ="client/img/category/c3.jpg" alt />
            ...
            <div className="col-lg-8 col-md-8">
              <div className="single-deal">
                <div className="overlay" />
                <img className="img-fluid w-100" src="client/img/category/c4.jpg" alt />
        ...
        <div className="col-lg-4 col-md-6">
          <div className="single-deal">
            <div className="overlay" />
            <img className="img-fluid w-100" src="client/img/category/c5.jpg" alt />
        ...
        <div className="row justify-content-center">
          <div className="col-lg-6 text-center">
            <div className="section-title">
              ...
              <p>Bộ sưu tập mẫu giày thu đông năm 2020 - Karma shop</p>
            </div>
          </div>
        </div>
        <div className="row">
          ...
          {products.map( ( {id,name,image,price}, index )=>(
            ...
            <div className="product-details">
                <h6><Link to={`/Singleproduct/${id}`}>{name}</Link></h6>
              <div className="price">
                <h6>{price}</h6>
        ...
        <div className="col-lg-6 no-padding exclusive-right">
          <div className="active-exclusive-product-slider">
            ...
            <div className="single-exclusive-slider">
              <img className="img-fluid" src="client/img/product/e-p1.png" alt />
              <div className="product-details">
                <div className="price">
                  <h6>$150.00</h6>
                  <h6 className="l-through">$210.00</h6>
    ...
    <div className="container">
      <div className="row">
        <a className="col single-img" href="#">
          <img className="img-fluid d-block mx-auto" src="client/img/brand/1.png" alt />
        </a>
        <a className="col single-img" href="#">
          <img className="img-fluid d-block mx-auto" src="client/img/brand/2.png" alt />
        </a>
        <a className="col single-img" href="#">
          <img className="img-fluid d-block mx-auto" src="client/img/brand/3.png" alt />
        </a>
        <a className="col single-img" href="#">
          <img className="img-fluid d-block mx-auto" src="client/img/brand/4.png" alt />
        </a>
        <a className="col single-img" href="#">
          <img className="img-fluid d-block mx-auto" src="client/img/brand/5.png" alt />
        </a>
      </div>
    </div>
  </section>
        ...
        <div className="col-lg-3">
          <div className="ctg-right">
            <a href="#" target="_blank">
              <img className="img-fluid d-block mx-auto" src="client/img/category/c5.jpg" alt />
            </a>
          </div>
        </div>
      </div>
